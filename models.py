...
class ProxiesPriv(models.Model):
    ...
    proxied_user = models.CharField(db_column='Proxied_user', max_length=16)  # Field name made lowercase.
...
class User(models.Model):
    ...
    plugin = models.CharField(max_length=64, blank=True, null=True)
